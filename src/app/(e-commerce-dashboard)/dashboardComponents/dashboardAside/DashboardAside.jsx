...
import LinksMap from "./dashboardAsideAtoms/linksMap/LinksMap";
...
export default function DashboardAside() {
  ...
  let topLinks = [
    ...
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26.25 19.25">
          <path
            id="Icon_ion-people"
    ...
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25.868 25.868">
          <path
    ...
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 29.406 23.821">
          <path
    ...
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26.738 23.767">
          <path
  ...
  let bottomLinks = [
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21.373 24.935">
          <path
    ...
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 27.373 25.992">
          <path
    ...
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.738 23.347">
          <g
  ...
  const lastName = getCookie("last");

  return (
    <div
      className={`h-[100vh] bg-lightGray right-0 fixed  bottom-0  flex flex-col items-end py-5 gap-4  shadow-md drawer overflow-hidden 
    ...
    >
      ...
      <div
        className={`aside-arrow ${
          !openDrawer ? "flex justify-center w-full" : "flex justify-end w-full"
        }`}
      >
        <DashboardArrow
      ...
      >
        ...
        <div
          ...
          } text-lightGray bg-orange rounded-full flex justify-center items-center  text-md md:text-xl`}
        >
          {firstName[0]}
        </div>
      </div>
      <button
        className="text-orange text-center w-full text-xl flex items-center justify-center"
        onClick={() => {
          logOut();
        }}
      >
